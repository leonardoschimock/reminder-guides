...
### Remove files:
    ...
    Remove-Item -Recurse -Force .git -> removes the connetion with github 
            (we can use that when we change posters adress, to create a git repository again with the right adress)
